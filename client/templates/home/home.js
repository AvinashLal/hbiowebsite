Template.home.rendered = function() {
  ...
  $(window).load(function(){
    ...
    $('#advisors-container').css({visibility:'visible'});

    $('#advisors-container').masonry({
      itemSelector: '.project-item:not(.filtered)',
      columnWidth:350,
      isFitWidth: true,
      isResizable: true,
  ...
  $('body').append('<img class="preload-image-event" src="assets/events-bg.jpg" style="display:none;"/>');
  ...
  $('#events').waypoint(function(direction) {
    if($('.preload-image-event').length){$('.preload-image-event').remove();}
    $('.backstretch').remove();
  
    if (direction=='down'){
      $.backstretch('assets/events-bg.jpg');
    }else{
      $.backstretch('assets/events-bg.jpg');
    }
